...
class JumpCfg(BaseConfig):
    ...
    class commands:
        curriculum = True
        max_curriculum = 3.
        num_commands = 6 # default: lin_vel_x, lin_vel_y, ang_vel_yaw, target_phase[1:]
        ...
        class ranges:
            ...
            heading = [-0 ,0]
            jump_up_height = [0.4, 0.8]  # max: 0.57
            jump_distance = [0.1, 1.0] # min max [m]
    ...
    class rewards:
        class scales:
            ...
            # feet_air_time = -1e-5
            termination = -0.0
            tracking_y_velocity = 0
            tracking_ang_vel = 0
            tracking_x_velocity = 0
            lin_vel_z = -0.
            ang_vel_xy = -0.
            work=-0.
            orientation = 0
