...
class LeggedRobotCfg(BaseConfig):
    ...
    class rewards:
        class scales:
            ...
            feet_slip = -5
            termination = -1.0
            action_rate = -0.01 # penalize action rate
            feet_air_time = 1.0
            cpg_freq = -0.01 # reward for penalizing large cpg omega
            # phase_contact_match = -1.0
            # orientation_yaw = -30. 
            # tracking_command_phase = 1.0 # reward for tracking the target phase
            # ang_vel_xy = -0.1 # reward for penalizing base angular velocity
